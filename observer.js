...
const slide4Indicator = document.querySelector(".slide4-indicator");
...
const observer = new IntersectionObserver(function (entries, observer) {
  entries.forEach((entry) => {
    ...
    if (entry.target == slide4) {
      slide4Indicator.classList.add("active");
    } else {
      slide4Indicator.classList.remove("active");
    }
  });
}, options);
